    ...
    context 'user is logged in' do
      ...
      context 'all params are valid' do
        it 'creates a booking' do
          ...
          expect(bookings.first.start_time.to_s).to match '10:00:00'
          expect(bookings.first.end_time.to_s).to match '11:00:00'
          expect(bookings.last.start_time.to_s).to match '08:00:00'
          expect(bookings.last.end_time.to_s).to match '09:00:00'
