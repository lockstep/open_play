    ...
    context 'user is logged in' do
      ...
      context 'all params are valid' do
        it 'creates a booking' do
          ...
          expect(response).to redirect_to orders_thank_path
        end
      end
    end
  ...
  def order_params(overrides={})
    {
      order: {
        bookings_attributes: [
          ...
          {
            start_time: '2000-01-01 02:00:00 UTC',
            end_time: '2000-01-01 03:00:00 UTC',
            reservable_id: overrides[:first_reservable],
            booking_date: '4/10/2016',
            players: '1'
          },
          {
            start_time: '2000-01-01 03:00:00 UTC',
            end_time: '2000-01-01 04:00:00 UTC',
